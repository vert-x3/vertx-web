...
public class ThymeleafTemplateTest extends WebTestBase {
  ...
  public void testTemplateHandlerOnClasspath() throws Exception {
    ...
    testTemplateHandler(engine, "somedir", "test-thymeleaf3-template2.html");
  }
  ...
  public void testWithLocale() throws Exception {
    ...
    testRequest(HttpMethod.GET, "/test-thymeleaf3-template2.html?param1=blah&param2=wibble", req -> req.putHeader("Accept-Language", "en-gb"), 200, "OK", null);
  }


  @Test
  public void testGetThymeLeafTemplateEngine() throws Exception {
    Thymeleaf3TemplateEngine engine = Thymeleaf3TemplateEngine.create();
