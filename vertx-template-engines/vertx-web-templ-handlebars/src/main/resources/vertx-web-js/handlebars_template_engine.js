...
var HandlebarsTemplateEngine = function(j_val) {
  ...
  this.setExtension = function(extension) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(HandlebarsTemplateEngine, j_handlebarsTemplateEngine["setExtension(java.lang.String)"](extension));
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  this.setMaxCacheSize = function(maxCacheSize) {
    ...
    if (__args.length === 1 && typeof __args[0] ==='number') {
      return utils.convReturnVertxGen(HandlebarsTemplateEngine, j_handlebarsTemplateEngine["setMaxCacheSize(int)"](maxCacheSize));
    } else throw new TypeError('function invoked with invalid arguments');
  };
