...
public class PebbleTemplateEngine extends TemplateEngine {
  ...
  public PebbleTemplateEngine setExtension(String extension) {
    def ret= InternalHelper.safeCreate(this.delegate.setExtension(extension), io.vertx.groovy.ext.web.templ.PebbleTemplateEngine.class);
    return ret;
  }
  /**
  ...
  public PebbleTemplateEngine setMaxCacheSize(int maxCacheSize) {
    def ret= InternalHelper.safeCreate(this.delegate.setMaxCacheSize(maxCacheSize), io.vertx.groovy.ext.web.templ.PebbleTemplateEngine.class);
    return ret;
  }
}
