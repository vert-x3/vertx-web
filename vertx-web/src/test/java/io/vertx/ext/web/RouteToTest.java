 ...
 */
public class RouteToTest extends WebTestBase {

  @Test
  public void testSimple() throws Exception {
    Router subRouter = Router.router(vertx);

    router.route("/subpath*").routeTo(subRouter);
  ...
  @Test
  public void testHandlerBeforeSubRouter() throws Exception {
    Router subRouter = Router.router(vertx);

    router
      .route("/subpath*")
      .handler(rc ->
        rc.put("key", "value").next()
      )
      .routeTo(subRouter);

    subRouter.route("/foo").handler(rc -> {
      assertEquals("/subpath", rc.mountPoint());
      rc.response().setStatusMessage(rc.get("key")).end();
    });

    testRequest(HttpMethod.GET, "/subpath/foo", 200, "value");
  ...
  public void testChain2() throws Exception {
    ...
    router.route("/foo").routeTo(subRouter);
  ...
  public void testMultipleSubrouters() throws Exception {
    ...
    router.route("/foo").routeTo(subRouter1);
    subRouter1.route("/bar").routeTo(subRouter2);
    subRouter2.route("/wibble").routeTo(subRouter3);
  ...
  public void testRegexInSubRouter() throws Exception {
    Router subRouter = Router.router(vertx);
    router.route("/api").routeTo(subRouter);
  ...
  public void testStackOverflow() throws Exception {
    ...
    router.route("/v1").routeTo(router);
