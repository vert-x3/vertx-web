...
[source,ruby]
----
require 'vertx-web/chain_auth_handler'
require 'vertx-web/basic_auth_handler'
require 'vertx-web/redirect_auth_handler'

chain = VertxWeb::ChainAuthHandler.create()

# add http basic auth handler to the chain
chain.append(VertxWeb::BasicAuthHandler.create(provider))
# add form redirect auth handler to the chain
chain.append(VertxWeb::RedirectAuthHandler.create(provider))

# secure your route
router.route("/secure/resource").handler(&chain.method(:handle))
# your app
