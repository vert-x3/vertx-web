...
router.get("/awesome/:pathParam").handler(&validationHandler.method(:handle)).handler() { |routingContext|
  ...
  # Get parameters
  parameterName = params.get_query_parameter("parameterName").get_integer()
  formParameterName = params.get_form_parameter("formParameterName").get_string()
  pathParam = params.get_path_parameter("pathParam").get_float()
...
----
require 'json'
require 'vertx-web/open_api3_router_factory'
# Load the api spec. This operation is asynchronous
VertxWeb::OpenAPI3RouterFactory.create_router_factory_from_file(vertx, "src/main/resources/petstore.yaml") { |openAPI3RouterFactoryAsyncResult_err,openAPI3RouterFactoryAsyncResult|
  if (openAPI3RouterFactoryAsyncResult_err == nil)
    ...
    routerFactory.add_handler_by_operation_id("listPets", lambda { |routingContext|
      ...
      failure = routingContext.failure()
      if (failure.class.name == 'Java::IoVertxExtWebValidation::ValidationException')
        routingContext.response().set_status_code(400).set_status_message("ValidationException thrown! #{failure.get_error_type().name()}").end()end
    }
    ...
    routerFactory.add_handler(:POST, "/pets", lambda { |routingContext|
      ...
      params = routingContext.get("parsedParameters")
      pet = params.get_body().get_json_object()
