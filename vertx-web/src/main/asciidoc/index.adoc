...
The main method {@link io.vertx.ext.web.RoutingContext#acceptableLanguages} will return the ordered list of languages the
user understands, if you're only interested in the user prefered language then the helper:
