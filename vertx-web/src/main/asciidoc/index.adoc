...
Vert.x provides an out of the box handler called {@link io.vertx.ext.web.handler.sockjs.SockJS} for
using SockJS in your Vert.x-Web applications.

You should create one handler per SockJS application using {@link io.vertx.ext.web.handler.sockjs.SockJS#create}.
You can also specify configuration options when creating the instance. The configuration options are described with
an instance of {@link io.vertx.ext.web.handler.sockjs.SockJSOptions}.
...
The handler can be configured with various options using {@link io.vertx.ext.web.handler.sockjs.SockJSOptions}.
...
It must enabled in {@link io.vertx.ext.web.handler.sockjs.SockJSOptions}.
...
It can be made cluster-wide with {@link io.vertx.ext.web.handler.sockjs.SockJSOptions#setLocalWriteHandler}.
...
terminating at at a {@link io.vertx.ext.web.handler.sockjs.SockJS} on the server-side.

A special SockJS socket handler is then installed on the {@link io.vertx.ext.web.handler.sockjs.SockJS} which
handles the SockJS data and bridges it to and from the server side event bus.

To activate the bridge you simply call
{@link io.vertx.ext.web.handler.sockjs.SockJS#bridge(io.vertx.ext.web.handler.sockjs.SockJSBridgeOptions)} on the
SockJS handler.
...
{@link io.vertx.ext.web.handler.sockjs.SockJS#bridge(io.vertx.ext.web.handler.sockjs.SockJSBridgeOptions, io.vertx.core.Handler)}.
