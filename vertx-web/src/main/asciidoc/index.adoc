...
set sensible limits on {@link io.vertx.ext.web.handler.BodyHandler#setBodyLimit} (e.g.: 10mb) and
{@link io.vertx.ext.web.handler.BodyHandler#setJsonLimit} (e.g.: 100kb).
