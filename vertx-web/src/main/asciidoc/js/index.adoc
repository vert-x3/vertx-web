...
`io.vertx:vertx-web-templ-mvel:3.5.0`. Create an instance of the MVEL template engine using:
...
`io.vertx:vertx-web-templ-jade:3.5.0`. Create an instance of the Jade template engine using:
...
`io.vertx:vertx-web-templ-handlebars:3.5.0`. Create an instance of the Handlebars template engine
...
`io.vertx:vertx-web-templ-thymeleaf:3.5.0`. Create an instance of the Thymeleaf template engine
...
`io.vertx:vertx-web-templ-freemarker:3.5.0`. Create an instance of the Apache FreeMarker template engine
...
`io.vertx:vertx-web-templ-pebble:3.5.0`. Create an instance of the Pebble template engine
...
[source,groovy,subs="+attributes"]
----
compile 'io.vertx:vertx-web:3.5.0:client'
----
