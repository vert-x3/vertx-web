...
router.route("/private/somepath").handler(function (routingContext) {
  ...
  var isAuthenticated = (routingContext.user() !== null && routingContext.user() !== undefined);
...
use the `link:../../jsdoc/module-vertx-web-js_chain_auth_handler-ChainAuthHandler.html[ChainAuthHandler]`. The chain auth handler will attempt to perform
...
* The `link:../../jsdoc/module-vertx-web-js_jwt_auth_handler-JWTAuthHandler.html[JWTAuthHandler]` requires `link:../../jsdoc/module-vertx-auth-jwt-js_jwt_auth-JWTAuth.html[JWTAuth]`.
* The `link:../../jsdoc/module-vertx-web-js_digest_auth_handler-DigestAuthHandler.html[DigestAuthHandler]` requires `link:../../jsdoc/module-vertx-auth-htdigest-js_htdigest_auth-HtdigestAuth.html[HtdigestAuth]`.
* The `link:../../jsdoc/module-vertx-web-js_o_auth2_auth_handler-OAuth2AuthHandler.html[OAuth2AuthHandler]` requires `link:../../jsdoc/module-vertx-auth-oauth2-js_o_auth2_auth-OAuth2Auth.html[OAuth2Auth]`.
...
* The `link:../../jsdoc/module-vertx-web-js_basic_auth_handler-BasicAuthHandler.html[BasicAuthHandler]` can take any provider.
* The `link:../../jsdoc/module-vertx-web-js_redirect_auth_handler-RedirectAuthHandler.html[RedirectAuthHandler]` can take any provider.
...
[source,js]
----
var ChainAuthHandler = require("vertx-web-js/chain_auth_handler");
var BasicAuthHandler = require("vertx-web-js/basic_auth_handler");
var RedirectAuthHandler = require("vertx-web-js/redirect_auth_handler");
...
// secure your route
router.route("/secure/resource").handler(chain.handle);
// your app
...
Vert.x provide a validation framework that will validate requests for you and will put results of validation inside a container. To define a `link:../../jsdoc/module-vertx-web-js_http_request_validation_handler-HTTPRequestValidationHandler.html[HTTPRequestValidationHandler]`:
[source,js]
----
var HTTPRequestValidationHandler = require("vertx-web-js/http_request_validation_handler");
...
If validation succeeds, It returns request parameters inside `link:../../jsdoc/module-vertx-web-js_request_parameters-RequestParameters.html[RequestParameters]`, otherwise It will throw a `ValidationException`

=== Types of request parameters
Every parameter has a type validator, a class that describes the expected type of parameter.
A type validator validates the value, casts it in required language type and then loads it inside a `link:../../jsdoc/module-vertx-web-js_request_parameter-RequestParameter.html[RequestParameter]` object. There are three ways to describe the type of your parameter:

* There is a set of prebuilt types that you can use: `link:../enums.html#ParameterType[ParameterType]`
* You can instantiate a custom instance of prebuilt type validators using static methods of `link:../../jsdoc/module-vertx-web-js_parameter_type_validator-ParameterTypeValidator.html[ParameterTypeValidator]` and then load it into `link:../../jsdoc/module-vertx-web-js_http_request_validation_handler-HTTPRequestValidationHandler.html[HTTPRequestValidationHandler]` using functions ending with `WithCustomTypeValidator`
* You can create your own `ParameterTypeValidator` implementing `link:../../jsdoc/module-vertx-web-js_parameter_type_validator-ParameterTypeValidator.html[ParameterTypeValidator]` interface
