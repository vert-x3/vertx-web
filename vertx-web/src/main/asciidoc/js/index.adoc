...
The event enables you to retrieve the type using `link:../../jsdoc/module-vertx-bridge-common-js_base_bridge_event-BaseBridgeEvent.html#type[type]` and
inspect the raw message of the event using `link:../../jsdoc/module-vertx-bridge-common-js_base_bridge_event-BaseBridgeEvent.html#getRawMessage[getRawMessage]`.
