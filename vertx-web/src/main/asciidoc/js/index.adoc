...
To create an auth handler you need an instance of `link:../../vertx-auth-common/js/jsdoc/auth_provider-AuthProvider.html[AuthProvider]`. Auth provider is
...
If the auth handler has successfully authenticated and authorised the user it will inject a `link:../../vertx-auth-common/js/jsdoc/user-User.html[User]`
...
When the basic auth handler receives this information, it calls the configured `link:../../vertx-auth-common/js/jsdoc/auth_provider-AuthProvider.html[AuthProvider]`
...
`io.vertx:vertx-web-templ-mvel:3.1.0-SNAPSHOT`. Create an instance of the MVEL template engine using:
...
`io.vertx:vertx-web-templ-jade:3.1.0-SNAPSHOT`. Create an instance of the Jade template engine using:
...
`io.vertx:vertx-web-templ-handlebars:3.1.0-SNAPSHOT`. Create an instance of the Handlebars template engine
...
`io.vertx:vertx-web-templ-thymeleaf:3.1.0-SNAPSHOT`. Create an instance of the Thymeleaf template engine
...
[source,groovy,subs="+attributes"]
----
compile io.vertx:vertx-web:3.1.0-SNAPSHOT:client
----
...
Notice that the API has changed between the 3.0 and 3.1 version. Please check the changelog. The previous client
...
The event is also an instance of `link:../../vertx-core/js/jsdoc/future-Future.html[Future]`. When you are finished handling the event you can
