...
router.get("/awesome/:pathParam").handler(validationHandler).handler({ routingContext ->
  ...
  // Get parameters
  def parameterName = params.getQueryParameter("parameterName").getInteger()
  def formParameterName = params.getFormParameter("formParameterName").getString()
  def pathParam = params.getPathParameter("pathParam").getFloat()
...
OpenAPI3RouterFactory.createRouterFactoryFromFile(vertx, "src/main/resources/petstore.yaml", { openAPI3RouterFactoryAsyncResult ->
  if (openAPI3RouterFactoryAsyncResult.succeeded()) {
    ...
    routerFactory.addHandler(HttpMethod.POST, "/pets", { routingContext ->
      ...
      def params = routingContext.get("parsedParameters")
      def pet = params.getBody().getJsonObject()
