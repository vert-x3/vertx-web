...
// a clustered Vert.x
Vertx.clusteredVertx(io.vertx.core.VertxOptions(
  clustered = true), { res ->
...
var options = io.vertx.ext.web.handler.sockjs.SockJSHandlerOptions(
...
var options = io.vertx.ext.web.handler.sockjs.BridgeOptions(
)
...
var inboundPermitted1 = io.vertx.ext.web.handler.sockjs.PermittedOptions(
  address = "demo.orderMgr")

// Allow calls to the address 'demo.persistor' from the client as long as the messages
// have an action field with value 'find' and a collection field with value
// 'albums'
var inboundPermitted2 = io.vertx.ext.web.handler.sockjs.PermittedOptions(
...
var inboundPermitted3 = io.vertx.ext.web.handler.sockjs.PermittedOptions(
  match = json {
    obj("wibble" to "foo")
  })
...
var outboundPermitted1 = io.vertx.ext.web.handler.sockjs.PermittedOptions(
  address = "ticker.mystock")

// Let through any messages from addresses starting with "news." (e.g. news.europe, news.usa, etc)
var outboundPermitted2 = io.vertx.ext.web.handler.sockjs.PermittedOptions(
  addressRegex = "news\\..+")
...
var inboundPermitted = io.vertx.ext.web.handler.sockjs.PermittedOptions(
...
var sockJSHandler = SockJSHandler.create(vertx)
sockJSHandler.bridge(io.vertx.ext.web.handler.sockjs.BridgeOptions(
  inboundPermitteds = listOf(inboundPermitted)))
...
var authProvider = OAuth2Auth.create(vertx, OAuth2FlowType.AUTH_CODE, io.vertx.ext.auth.oauth2.OAuth2ClientOptions(
  clientID = "CLIENT_ID",
