...
public interface Route {
   ...
   * <p>
   * To match a literal colon in a non-regex route path, escape it as {@code \:}; for example,
   * {@code /foo/\:bar}. When passing the path as a string literal, escape the backslash as required
