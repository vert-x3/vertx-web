...
public abstract class BaseParameter implements Parameter {
  ...
  protected abstract String getValue(RoutingContext context);

  @Override
  public final StringBuilder print(RoutingContext context) {
    StringBuilder result = new StringBuilder();

    if (shouldPrint(context.response().getStatusCode())) {
