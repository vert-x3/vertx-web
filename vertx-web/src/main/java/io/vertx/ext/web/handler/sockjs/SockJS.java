...
public interface SockJS {
   ...
   * @return the handler
   */
  static SockJS create(Vertx vertx) {
    return new SockJSImpl(vertx, new SockJSOptions());
  }
   ...
   * @return the handler
   */
  static SockJS create(Vertx vertx, SockJSOptions options) {
  ...
  /**
   * Like {@link SockJS#bridge(SockJSBridgeOptions)} but specifying a handler
