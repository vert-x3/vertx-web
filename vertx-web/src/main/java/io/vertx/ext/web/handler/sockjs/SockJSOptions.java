...
public class SockJSOptions {
   ...
   */
  public SockJSOptions(SockJSOptions other) {
   ...
   * @param json the JSON
   */
  public SockJSOptions(JsonObject json) {
   ...
   */
  public SockJSOptions setSessionTimeout(long sessionTimeout) {
    if (sessionTimeout < 1) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public SockJSOptions setInsertJSESSIONID(boolean insertJSESSIONID) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public SockJSOptions setHeartbeatInterval(long heartbeatInterval) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public SockJSOptions setMaxBytesStreaming(int maxBytesStreaming) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public SockJSOptions setLibraryURL(String libraryURL) {
   ...
   * @see Transport
   */
  public SockJSOptions addDisabledTransport(String subProtocol) {
   ...
   * @see SockJSSocket#writeHandlerID()
   */
  public SockJSOptions setRegisterWriteHandler(boolean registerWriteHandler) {
   ...
   * @see SockJSSocket#writeHandlerID()
   */
  public SockJSOptions setLocalWriteHandler(boolean localWriteHandler) {
   ...
   * @return a reference to this, so the API can be used fluently
   */
  public SockJSOptions setOrigin(String origin) {
    this.origin = origin;
    return this;
  }
}
