...
public class RedirectAuthHandler implements AuthHandler {
  private final def io.vertx.ext.web.handler.RedirectAuthHandler delegate;
  ...
  public static AuthHandler create(AuthProvider authProvider) {
    def ret = InternalHelper.safeCreate(io.vertx.ext.web.handler.RedirectAuthHandler.create(authProvider != null ? (io.vertx.ext.auth.AuthProvider)authProvider.getDelegate() : null), io.vertx.groovy.ext.web.handler.AuthHandlerImpl.class);
    return ret;
  }
  /**
   * Create a handler
  ...
  public static AuthHandler create(AuthProvider authProvider, String loginRedirectURL) {
    def ret = InternalHelper.safeCreate(io.vertx.ext.web.handler.RedirectAuthHandler.create(authProvider != null ? (io.vertx.ext.auth.AuthProvider)authProvider.getDelegate() : null, loginRedirectURL), io.vertx.groovy.ext.web.handler.AuthHandlerImpl.class);
    return ret;
  }
  /**
   * Create a handler
  ...
  public static AuthHandler create(AuthProvider authProvider, String loginRedirectURL, String returnURLParam) {
    def ret = InternalHelper.safeCreate(io.vertx.ext.web.handler.RedirectAuthHandler.create(authProvider != null ? (io.vertx.ext.auth.AuthProvider)authProvider.getDelegate() : null, loginRedirectURL, returnURLParam), io.vertx.groovy.ext.web.handler.AuthHandlerImpl.class);
    return ret;
  }
}
