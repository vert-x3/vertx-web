...
import serviceproxy.testmodel.TestService;
...
import serviceproxy.testmodel.TestConnectionWithCloseFuture;
...
import java.util.Map;
import serviceproxy.testmodel.TestService;
import serviceproxy.testmodel.TestConnection;
import io.vertx.core.json.JsonObject;
import io.vertx.core.AsyncResult;
import io.vertx.core.Handler;
  ...
  public void handle(Message<JsonObject> msg) {
    try {
      ...
      switch (action) {
        ...
        case "enumType": {
          service.enumType(json.getString("someEnum") == null ? null : serviceproxy.testmodel.SomeEnum.valueOf(json.getString("someEnum")));
          break;
        }
        case "enumTypeNull": {
          service.enumTypeNull(json.getString("someEnum") == null ? null : serviceproxy.testmodel.SomeEnum.valueOf(json.getString("someEnum")));
          break;
        }
        ...
        case "dataObjectType": {
          service.dataObjectType(json.getJsonObject("options") == null ? null : new serviceproxy.testmodel.TestDataObject(json.getJsonObject("options")));
          break;
        }
        case "dataObjectTypeNull": {
          service.dataObjectTypeNull(json.getJsonObject("options") == null ? null : new serviceproxy.testmodel.TestDataObject(json.getJsonObject("options")));
          break;
        }
        case "listParams": {
        ...
        case "invokeWithMessage": {
          service.invokeWithMessage((io.vertx.core.json.JsonObject)json.getValue("object"), (java.lang.String)json.getValue("str"), json.getValue("i") == null ? null : (json.getLong("i").intValue()), json.getInteger("chr") == null ? null : (char)(int)(json.getInteger("chr")), json.getString("senum") == null ? null : serviceproxy.testmodel.SomeEnum.valueOf(json.getString("senum")), createHandler(msg));
          break;
        }
