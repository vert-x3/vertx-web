...
public class ApolloWSOptionsConverter {
  ...
  private static final Base64.Encoder BASE64_ENCODER = JsonUtil.BASE64_ENCODER;
   ...
   static void fromJson(Iterable<java.util.Map.Entry<String, Object>> json, ApolloWSOptions obj) {
   ...
   static void toJson(ApolloWSOptions obj, JsonObject json) {
    toJson(obj, json.getMap());
  }

   static void toJson(ApolloWSOptions obj, java.util.Map<String, Object> json) {
