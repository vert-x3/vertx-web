...
Vert.x {@link io.vertx.core.Future} can be converted to `CompletionStage`:

[source,$lang]
----
{@link examples.GraphQLExamples#completionStageInterop}
----
...
TIP: If you work with Vert.x callback-based APIs, you may use a {@link io.vertx.ext.web.handler.graphql.dataloader.VertxBatchLoader} to simplify your code.
