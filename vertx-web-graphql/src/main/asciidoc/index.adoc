...
TIP: If you work with Vert.x callback-based APIs, you may use a {@link io.vertx.ext.web.handler.graphql.VertxBatchLoader} or a {@link io.vertx.ext.web.handler.graphql.VertxMappedBatchLoader} to simplify your code.
