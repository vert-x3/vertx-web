 ...
 * <p>
 * The session is available on the routing context with {@link io.vertx.ext.web.RoutingContext#session()}.
 * <p>
 * The session handler requires a {@link io.vertx.ext.web.handler.CookieHandler} to be on the routing chain before it.
 *
