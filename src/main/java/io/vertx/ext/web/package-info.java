 ...
 *
 * You use {@link io.vertx.ext.web.RoutingContext#getCookie(java.lang.String)} to retrieve
 * a cookie by name, or use {@link io.vertx.ext.web.RoutingContext#cookies()} to retrieve the entire set.
 *
 * To remove a cookie, use {@link io.vertx.ext.web.RoutingContext#removeCookie(java.lang.String)}.
 *
 ...
 * data from the session with {@link io.vertx.ext.web.Session#remove(java.lang.String)}.
 *
 ...
 * This can be configured with {@link io.vertx.ext.web.handler.StaticHandler#setIndexPage(java.lang.String)}.
 *
 * === Changing the web root
 *
 * By default static resources will be served from the directory `webroot`. To configure this use
 * {@link io.vertx.ext.web.handler.StaticHandler#setWebRoot(java.lang.String)}.
 *
 ...
 *
 * When using the {@link io.vertx.ext.web.templ.MVELTemplateEngine MVEL template engine}, it will by default look for
 ...
 *
 * When using the {@link io.vertx.ext.web.templ.JadeTemplateEngine Jade template engine}, it will by default look for
 ...
 *
 * When using the {@link io.vertx.ext.web.templ.HandlebarsTemplateEngine Handlebars template engine}, it will by default look for
 ...
 * 
 * When using the {@link io.vertx.ext.web.templ.ThymeleafTemplateEngine Thymeleaf template engine}, it will by default look for
