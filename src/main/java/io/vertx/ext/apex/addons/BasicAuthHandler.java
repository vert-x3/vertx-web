 ...
 */
public interface BasicAuthHandler extends Handler<RoutingContext> {

  static final String DEFAULT_REALM = "apex";

  static BasicAuthHandler basicAuthHandler(AuthService authService) {
    return new BasicAuthHandlerImpl(authService, DEFAULT_REALM);
  }

  static BasicAuthHandler basicAuthHandler(AuthService authService, String realm) {
