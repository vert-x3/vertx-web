...
public class Route {
  ...
  public Route produces(String contentType) {
    def ret= new io.vertx.groovy.ext.web.Route(this.delegate.produces(contentType));
    return ret;
  }
  /**
   ...
   * This method works just like {@link io.vertx.groovy.ext.web.Route#handler} excepted that it will run the blocking handler on a different thread
