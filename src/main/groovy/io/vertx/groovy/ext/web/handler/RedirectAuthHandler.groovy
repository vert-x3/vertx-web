...
public class RedirectAuthHandler implements AuthHandler {
  ...
  public static AuthHandler create(AuthProvider authProvider) {
    def ret= InternalHelper.safeCreate(io.vertx.ext.web.handler.RedirectAuthHandler.create((io.vertx.ext.auth.AuthProvider)authProvider.getDelegate()), io.vertx.groovy.ext.web.handler.AuthHandlerImpl.class);
    return ret;
  }
  /**
   * Create a handler
  ...
  public static AuthHandler create(AuthProvider authProvider, String loginRedirectURL) {
    def ret= InternalHelper.safeCreate(io.vertx.ext.web.handler.RedirectAuthHandler.create((io.vertx.ext.auth.AuthProvider)authProvider.getDelegate(), loginRedirectURL), io.vertx.groovy.ext.web.handler.AuthHandlerImpl.class);
    return ret;
  }
  /**
   * Create a handler
  ...
  public static AuthHandler create(AuthProvider authProvider, String loginRedirectURL, String returnURLParam) {
    def ret= InternalHelper.safeCreate(io.vertx.ext.web.handler.RedirectAuthHandler.create((io.vertx.ext.auth.AuthProvider)authProvider.getDelegate(), loginRedirectURL, returnURLParam), io.vertx.groovy.ext.web.handler.AuthHandlerImpl.class);
    return ret;
  }
}
