...
public class LocaleHandler implements Handler<RoutingContext> {
  final def io.vertx.ext.apex.handler.LocaleHandler delegate;
  ...
  public static LocaleHandler create() {
    def ret= new io.vertx.groovy.ext.apex.handler.LocaleHandler(io.vertx.ext.apex.handler.LocaleHandler.create());
    return ret;
  }
}
