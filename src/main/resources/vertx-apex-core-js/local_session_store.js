...
/** @module vertx-apex-core-js/local_session_store */
var utils = require('vertx-js/util/utils');
var SessionStore = require('vertx-apex-core-js/session_store');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JLocalSessionStore = io.vertx.ext.apex.core.LocalSessionStore;
...
/**
 ...
 @memberof module:vertx-apex-core-js/local_session_store
 @param vertx {Vertx} 
...
LocalSessionStore.localSessionStore = function() {
  ...
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return new LocalSessionStore(JLocalSessionStore.localSessionStore(__args[0]._jdel));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string') {
    return new LocalSessionStore(JLocalSessionStore.localSessionStore(__args[0]._jdel, __args[1]));
  }else if (__args.length === 3 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string' && typeof __args[2] ==='number') {
    return new LocalSessionStore(JLocalSessionStore.localSessionStore(__args[0]._jdel, __args[1], __args[2]));
