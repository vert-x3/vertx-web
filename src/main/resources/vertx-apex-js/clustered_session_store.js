...
/** @module vertx-apex-js/clustered_session_store */
var utils = require('vertx-js/util/utils');
var SessionStore = require('vertx-apex-js/session_store');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JClusteredSessionStore = io.vertx.ext.apex.sstore.ClusteredSessionStore;
...
/**
 ...
 @memberof module:vertx-apex-js/clustered_session_store
...
ClusteredSessionStore.create = function() {
  ...
  if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
    return new ClusteredSessionStore(JClusteredSessionStore.create(__args[0]._jdel));
  }else if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'string') {
    return new ClusteredSessionStore(JClusteredSessionStore.create(__args[0]._jdel, __args[1]));
