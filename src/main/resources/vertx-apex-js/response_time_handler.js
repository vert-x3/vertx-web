...
/** @module vertx-apex-js/response_time_handler */
var utils = require('vertx-js/util/utils');
var RoutingContext = require('vertx-apex-js/routing_context');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JResponseTimeHandler = io.vertx.ext.apex.handler.ResponseTimeHandler;
...
var ResponseTimeHandler = function(j_val) {
  ...
  this.handle = function(arg0) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'object' && __args[0]._jdel) {
      j_responseTimeHandler["handle(io.vertx.ext.apex.RoutingContext)"](arg0._jdel);
...
/**
 ...
 @memberof module:vertx-apex-js/response_time_handler
