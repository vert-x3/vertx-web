...
# Generated from io.vertx.ext.apex.handler.RedirectAuthHandler
module VertxApex
  #  An auth handler that's used to handle auth by redirecting user to a custom login page.
  class RedirectAuthHandler
    include ::VertxApex::AuthHandler
    # @private
    # @param j_del [::VertxApex::RedirectAuthHandler] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxApex::RedirectAuthHandler] the underlying java delegate
    def j_del
      @j_del
    end
    ...
    # @return [::VertxApex::AuthHandler] the handler
    def self.create(authProvider=nil,loginRedirectURL=nil,returnURLParam=nil)
      if authProvider.class.method_defined?(:j_del) && !block_given? && loginRedirectURL == nil && returnURLParam == nil
        return ::VertxApex::AuthHandlerImpl.new(Java::IoVertxExtApexHandler::RedirectAuthHandler.java_method(:create, [Java::IoVertxExtAuth::AuthProvider.java_class]).call(authProvider.j_del))
      elsif authProvider.class.method_defined?(:j_del) && loginRedirectURL.class == String && !block_given? && returnURLParam == nil
        return ::VertxApex::AuthHandlerImpl.new(Java::IoVertxExtApexHandler::RedirectAuthHandler.java_method(:create, [Java::IoVertxExtAuth::AuthProvider.java_class,Java::java.lang.String.java_class]).call(authProvider.j_del,loginRedirectURL))
      elsif authProvider.class.method_defined?(:j_del) && loginRedirectURL.class == String && returnURLParam.class == String && !block_given?
        return ::VertxApex::AuthHandlerImpl.new(Java::IoVertxExtApexHandler::RedirectAuthHandler.java_method(:create, [Java::IoVertxExtAuth::AuthProvider.java_class,Java::java.lang.String.java_class,Java::java.lang.String.java_class]).call(authProvider.j_del,loginRedirectURL,returnURLParam))
      end
