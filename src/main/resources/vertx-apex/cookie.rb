...
# Generated from io.vertx.ext.apex.Cookie
module VertxApex
  ...
  class Cookie
    # @private
    # @param j_del [::VertxApex::Cookie] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxApex::Cookie] the underlying java delegate
    def j_del
      @j_del
    end
    #  Create a new cookie
