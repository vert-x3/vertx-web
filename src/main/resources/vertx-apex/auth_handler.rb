...
# Generated from io.vertx.ext.apex.handler.AuthHandler
module VertxApex
  module AuthHandler
  ...
  class AuthHandlerImpl
    include AuthHandler
    # @private
    # @param j_del [::VertxApex::AuthHandler] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxApex::AuthHandler] the underlying java delegate
    def j_del
      @j_del
    end
  end
