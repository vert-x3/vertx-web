...
# Generated from io.vertx.ext.apex.handler.sockjs.BridgeEvent
module VertxApex
  ...
  class BridgeEvent < ::Vertx::Future
    # @private
    # @param j_del [::VertxApex::BridgeEvent] the java delegate
    def initialize(j_del)
      super(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxApex::BridgeEvent] the underlying java delegate
    def j_del
      @j_del
    end
    ...
    # @return [::VertxApex::SockJSSocket] the SockJSSocket instance
    def socket
      if !block_given?
        if @cached_socket != nil
          return @cached_socket
        end
        return @cached_socket = ::VertxApex::SockJSSocket.new(@j_del.java_method(:socket, []).call())
      end
