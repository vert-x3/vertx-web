...
# Generated from io.vertx.ext.apex.handler.StaticHandler
module VertxApex
  #  A handler for serving static resources from the file system or classpath.
  class StaticHandler
    # @private
    # @param j_del [::VertxApex::StaticHandler] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxApex::StaticHandler] the underlying java delegate
    def j_del
      @j_del
    end
    ...
    # @return [::VertxApex::StaticHandler] the handler
    def self.create(root=nil)
      if !block_given? && root == nil
        return ::VertxApex::StaticHandler.new(Java::IoVertxExtApexHandler::StaticHandler.java_method(:create, []).call())
      elsif root.class == String && !block_given?
        return ::VertxApex::StaticHandler.new(Java::IoVertxExtApexHandler::StaticHandler.java_method(:create, [Java::java.lang.String.java_class]).call(root))
      end
