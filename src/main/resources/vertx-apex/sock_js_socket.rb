...
# Generated from io.vertx.ext.apex.handler.sockjs.SockJSSocket
module VertxApex
  # 
  #  You interact with SockJS clients through instances of SockJS socket.
  #  <p>
  #  The API is very similar to {::Vertx::WebSocket}.
  #  It implements both {::Vertx::ReadStream} and {::Vertx::WriteStream}
  ...
  class SockJSSocket
    ...
    # @private
    # @param j_del [::VertxApex::SockJSSocket] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxApex::SockJSSocket] the underlying java delegate
    def j_del
      @j_del
    end
    # @return [true,false]
