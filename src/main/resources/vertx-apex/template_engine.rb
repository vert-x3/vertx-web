...
# Generated from io.vertx.ext.apex.templ.TemplateEngine
module VertxApex
  ...
  class TemplateEngine
    # @private
    # @param j_del [::VertxApex::TemplateEngine] the java delegate
    def initialize(j_del)
      @j_del = j_del
    end
    # @private
    # @return [::VertxApex::TemplateEngine] the underlying java delegate
    def j_del
      @j_del
    end
    #  Render
    ...
    def render(context=nil,templateFileName=nil)
      if context.class.method_defined?(:j_del) && templateFileName.class == String && block_given?
        return @j_del.java_method(:render, [Java::IoVertxExtApex::RoutingContext.java_class,Java::java.lang.String.java_class,Java::IoVertxCore::Handler.java_class]).call(context.j_del,templateFileName,(Proc.new { |ar| yield(ar.failed ? ar.cause : nil, ar.succeeded ? ::Vertx::Buffer.new(ar.result) : nil) }))
      end
