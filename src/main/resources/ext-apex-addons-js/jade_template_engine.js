...
/** @module ext-apex-addons-js/jade_template_engine */
var utils = require('vertx-js/util/utils');
var TemplateEngine = require('ext-apex-addons-js/template_engine');

var io = Packages.io;
var JsonObject = io.vertx.core.json.JsonObject;
var JJadeTemplateEngine = io.vertx.ext.apex.addons.JadeTemplateEngine;
...
/**
 ...
 @memberof module:ext-apex-addons-js/jade_template_engine
...
JadeTemplateEngine.create = function() {
  ...
  if (__args.length === 0) {
    ...
    return new JadeTemplateEngine(JJadeTemplateEngine.create(__args[0], __args[1]));
  }else if (__args.length === 3 && typeof __args[0] === 'string' && typeof __args[1] === 'string' && typeof __args[2] ==='number') {
    return new JadeTemplateEngine(JJadeTemplateEngine.create(__args[0], __args[1], __args[2]));
