...
To create an auth handler you need an instance of `link:../../vertx-auth-service/ruby/yardoc/VertxAuth/AuthProvider.html[AuthProvider]`. Auth provider is
...
config[Java::IoVertxExtAuthShiro::PropertiesAuthRealmConstants::PROPERTIES_PROPS_PATH_FIELD] = "classpath:test-auth.properties"

authProvider = VertxAuth::ShiroAuthProvider.create(vertx, :PROPERTIES, config)
...
router.route("/private/somepath").handler() { |routingContext|
  ...
  isLoggedIn = routingContext.session().logged_in?()
...
`link:yardoc/VertxApex/Session.html#is_logged_in-instance_method[isLoggedIn]` and you can get the principal with
`link:yardoc/VertxApex/Session.html#get_principal-instance_method[getPrincipal]`.

If you want to cause the user to be logged out you can call `link:yardoc/VertxApex/Session.html#logout-instance_method[logout]`.
...
When the basic auth handler receives this information, it calls the configured `link:../../vertx-auth-service/ruby/yardoc/VertxAuth/AuthProvider.html[auth service]`
...
authConfig[Java::IoVertxExtAuthShiro::PropertiesAuthRealmConstants::PROPERTIES_PROPS_PATH_FIELD] = "classpath:test-auth.properties"
authProvider = VertxAuth::ShiroAuthProvider.create(vertx, :PROPERTIES, authConfig)
