...
You can also specify that a route is handled last, with `link:groovydoc/io/vertx/groovy/ext/web/Route.html#last(boolean)[last]`
...
Alternatively you can access the entire context data map with `link:groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#data()[data]`.
...
In your handlers you an access the session instance with `link:groovydoc/io/vertx/groovy/ext/web/RoutingContext.html#session()[session]`.
...
To create an auth handler you need an instance of `link:../../vertx-auth/groovy/groovydoc/io/vertx/groovy/ext/auth/AuthProvider.html[AuthProvider]`. Auth provider is
...
def config = [:]
config.io.vertx.ext.auth.shiro.PropertiesProviderConstants.PROPERTIES_PROPS_PATH_FIELD = "classpath:test-auth.properties"

def authProvider = ShiroAuth.create(vertx, ShiroAuthRealmType.PROPERTIES, config)
...
If the auth handler has successfully authenticated and authorised the user it will inject a `link:../../vertx-auth/groovy/groovydoc/io/vertx/groovy/ext/auth/User.html[User]`
...
When the basic auth handler receives this information, it calls the configured `link:../../vertx-auth/groovy/groovydoc/io/vertx/groovy/ext/auth/AuthProvider.html[AuthProvider]`
...
def managerAuthHandler = RedirectAuthHandler.create(authProvider)
...
When using the `link:groovydoc/io/vertx/groovy/ext/web/templ/MVELTemplateEngine.html[MVEL template engine]`, it will by default look for
...
When using the `link:groovydoc/io/vertx/groovy/ext/web/templ/JadeTemplateEngine.html[Jade template engine]`, it will by default look for
...
When using the `link:groovydoc/io/vertx/groovy/ext/web/templ/HandlebarsTemplateEngine.html[Handlebars template engine]`, it will by default look for
...
When using the `link:groovydoc/io/vertx/groovy/ext/web/templ/ThymeleafTemplateEngine.html[Thymeleaf template engine]`, it will by default look for
...
def authConfig = [:]
authConfig.io.vertx.ext.auth.shiro.PropertiesProviderConstants.PROPERTIES_PROPS_PATH_FIELD = "classpath:test-auth.properties"
def authProvider = ShiroAuth.create(vertx, ShiroAuthRealmType.PROPERTIES, authConfig)
