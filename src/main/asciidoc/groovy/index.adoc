...
an instance of `link:groovydoc/io/vertx/groovy/ext/apex/handler/sockjs/SockJSHandlerOptions.html[SockJSHandlerOptions]`.
...
The handler can be configured with various options using `link:groovydoc/io/vertx/groovy/ext/apex/handler/sockjs/SockJSHandlerOptions.html[SockJSHandlerOptions]`.
...
`link:groovydoc/io/vertx/groovy/ext/apex/handler/sockjs/BridgeOptions.html[BridgeOptions]` that you pass in when calling bridge.
