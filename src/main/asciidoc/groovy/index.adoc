...
You can also use `link:groovydoc/io/vertx/groovy/ext/apex/Session.html#setAccessed()[setAccessed]` to manually mark a session as accessed.
...
object into the `link:groovydoc/io/vertx/groovy/ext/apex/RoutingContext.html[RoutingContext]` so it's available in your handlers with:
`link:groovydoc/io/vertx/groovy/ext/apex/RoutingContext.html#user()[user]`.
...
`link:groovydoc/io/vertx/groovy/ext/apex/handler/sockjs/SockJSHandler.html#bridge(io.vertx.ext.apex.handler.sockjs.BridgeOptions,%20io.vertx.core.Handler)[bridge]`.

Whenever an event occurs on the bridge it will be passed to the handler. The event is described by an instance of
`link:groovydoc/io/vertx/groovy/ext/apex/handler/sockjs/BridgeEvent.html[BridgeEvent]`.
...
The event enables you to retrieve the type using `link:groovydoc/io/vertx/groovy/ext/apex/handler/sockjs/BridgeEvent.html#type()[type]` and
inspect the raw message of the event using `link:groovydoc/io/vertx/groovy/ext/apex/handler/sockjs/BridgeEvent.html#rawMessage()[rawMessage]`.
