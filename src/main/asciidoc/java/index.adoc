...
To create an auth handler you need an instance of `link:apidocs/io/vertx/ext/auth/AuthService.html[AuthService]`. Auth service is
...
login ID with `link:apidocs/io/vertx/ext/apex/Session.html#isLoggedIn--[isLoggedIn]` and `link:apidocs/io/vertx/ext/apex/Session.html#getLoginID--[getLoginID]`.
...
When the basic auth handler receives this information, it calls the configured `link:apidocs/io/vertx/ext/auth/AuthService.html[auth service]`
...
Each match is a `link:apidocs/io/vertx/ext/apex/handler/sockjs/PermissionOptions.html[PermissionOptions]` object:

`link:apidocs/io/vertx/ext/apex/handler/sockjs/PermissionOptions.html#setAddress-java.lang.String-[setAddress]`:: This represents the exact address the message is being sent to. If you want to allow messages based on
an exact address you use this field.
`link:apidocs/io/vertx/ext/apex/handler/sockjs/PermissionOptions.html#setAddressRegex-java.lang.String-[setAddressRegex]`:: This is a regular expression that will be matched against the address. If you want to allow messages
based on a regular expression you use this field. If the `address` field is specified this field will be ignored.
`link:apidocs/io/vertx/ext/apex/handler/sockjs/PermissionOptions.html#setMatch-io.vertx.core.json.JsonObject-[setMatch]`:: This allows you to allow messages based on their structure. Any fields in the match must exist in the
...
`link:apidocs/io/vertx/ext/apex/handler/sockjs/PermissionOptions.html#setRequiredRole-java.lang.String-[setRequiredRole]` field.
...
`link:apidocs/io/vertx/ext/apex/handler/sockjs/PermissionOptions.html#setRequiredPermission-java.lang.String-[setRequiredPermission]` field.
