...
To enable sessions in your application you make sure you have a link:apidocs/io/vertx/ext/apex/core/SessionHandler.html[`SessionHandler`]
...
link:apidocs/io/vertx/ext/apex/core/LocalSessionStore.html#localSessionStore-io.vertx.core.Vertx-java.lang.String-long-[`LocalSessionStore.localSessionStore`].

Here are some examples of creating a link:apidocs/io/vertx/ext/apex/core/LocalSessionStore.html[`LocalSessionStore`]
...
Here are some examples of creating a link:apidocs/io/vertx/ext/apex/core/ClusteredSessionStore.html[`ClusteredSessionStore`]
...
You'll also need to include a link:apidocs/io/vertx/ext/apex/core/CookieHandler.html[`CookieHandler`] as the session handler uses cookies to
...
In your handlers you an access the session instance with link:apidocs/io/vertx/ext/apex/core/RoutingContext.html#session--[`session`].

You put data into the session with link:apidocs/io/vertx/ext/apex/core/Session.html#put-java.lang.String-java.lang.Object-[`put`],
you get data from the session with link:apidocs/io/vertx/ext/apex/core/Session.html#get-java.lang.String-[`get`], and you remove
data from the session with link:apidocs/io/vertx/ext/apex/core/Session.html#remove-java.lang.String-[`remove`].
...
You can manually destroy a session using link:apidocs/io/vertx/ext/apex/core/Session.html#destroy--[`destroy`]. This will remove the session
...
principal with link:apidocs/io/vertx/ext/apex/core/Session.html#isLoggedIn--[`isLoggedIn`] and link:apidocs/io/vertx/ext/apex/core/Session.html#getPrincipal--[`getPrincipal`].

If you want to cause the user to be logged out you can call link:apidocs/io/vertx/ext/apex/core/Session.html#logout--[`logout`].
...
To use redirect auth you configure an instance of link:apidocs/io/vertx/ext/apex/addons/RedirectAuthHandler.html[`RedirectAuthHandler`] instead of a
basic auth handler.

You will also need to setup handlers to serve your actual login page, and a handler to handle the actual login itself.
To handle the login we provide a prebuilt handler link:apidocs/io/vertx/ext/apex/addons/FormLoginHandler.html[`FormLoginHandler`] for the purpose.
...
link:apidocs/io/vertx/ext/apex/addons/StaticServer.html[`StaticServer`].
...
link:apidocs/io/vertx/ext/apex/addons/StaticServer.html#setMaxAgeSeconds-long-[`setMaxAgeSeconds`] if required.
...
If handling of cache headers is not required, it can be disabled with link:apidocs/io/vertx/ext/apex/addons/StaticServer.html#setCachingEnabled-boolean-[`setCachingEnabled`].
...
link:apidocs/io/vertx/ext/apex/addons/StaticServer.html#setFilesReadOnly-boolean-[`setFilesReadOnly`].

To enable the maximum number of entries that can be cached in memory at any one time you can use
link:apidocs/io/vertx/ext/apex/addons/StaticServer.html#setMaxCacheSize-int-[`setMaxCacheSize`].

To configure the expiry time of cache entries you can use link:apidocs/io/vertx/ext/apex/addons/StaticServer.html#setCacheEntryTimeout-long-[`setCacheEntryTimeout`].
...
This can be configured with link:apidocs/io/vertx/ext/apex/addons/StaticServer.html#setIndexPage-java.lang.String-[`setIndexPage`].

=== Changing the web root

By default static resources will be served from the directory `webroot`. To configure this use
link:apidocs/io/vertx/ext/apex/addons/StaticServer.html#setWebRoot-java.lang.String-[`setWebRoot`].

=== Serving hidden files

By default the serve will serve hidden files (files starting with `.`).

If you do not want hidden files to be served you can configure it with link:apidocs/io/vertx/ext/apex/addons/StaticServer.html#setIncludeHidden-boolean-[`setIncludeHidden`].

=== Directory listing

The server can also perform directory listing. By default directory listing is disabled. To enabled it use
link:apidocs/io/vertx/ext/apex/addons/StaticServer.html#setDirectoryListing-boolean-[`setDirectoryListing`].
...
link:apidocs/io/vertx/ext/apex/addons/StaticServer.html#setDirectoryTemplate-java.lang.String-[`setDirectoryTemplate`].
...
Apex includes a handler link:apidocs/io/vertx/ext/apex/addons/CorsHandler.html[`CorsHandler`] that handles the CORS protocol for you.
...
Template engines are described by link:apidocs/io/vertx/ext/apex/addons/TemplateEngine.html[`TemplateEngine`]. In order to render a template
link:apidocs/io/vertx/ext/apex/addons/TemplateEngine.html#render-io.vertx.ext.apex.core.RoutingContext-java.lang.String-io.vertx.core.Handler-[`render`] is used.

The simplest way to use templates is not to call the template engine directly but to use the
link:apidocs/io/vertx/ext/apex/addons/PathTemplateHandler.html[`PathTemplateHandler`].
...
When using the link:apidocs/io/vertx/ext/apex/addons/MVELTemplateEngine.html[`MVEL template engine`], it will by default look for
templates with the `.templ` extension if no extension is specified in the file name.

The routing context (link:apidocs/io/vertx/ext/apex/core/RoutingContext.html[`RoutingContext`] is available
...
When using the link:apidocs/io/vertx/ext/apex/addons/JadeTemplateEngine.html[`Jade template engine`], it will by default look for
...
When using the link:apidocs/io/vertx/ext/apex/addons/HandlebarsTemplateEngine.html[`Handlebars template engine`], it will by default look for
...
Instead, the link:apidocs/io/vertx/ext/apex/core/RoutingContext.html#contextData--[`contextData`] is available in the template.
...
When using the link:apidocs/io/vertx/ext/apex/addons/ThymeleafTemplateEngine.html[`Thymeleaf template engine`], it will by default look for
...
The handler is link:apidocs/io/vertx/ext/apex/addons/ErrorHandler.html[`ErrorHandler`]. To use the error handler just set it as a
failure handler for any paths that you want covered.

== Request logger

Apex includes a handler link:apidocs/io/vertx/ext/apex/addons/Logger.html[`Logger`] that you can use to log HTTP requests.
...
Apex includes the handler link:apidocs/io/vertx/ext/apex/addons/Favicon.html[`Favicon`] especially for serving favicons.
...
This is configured using an instance of link:apidocs/io/vertx/ext/apex/addons/Timeout.html[`Timeout`].
