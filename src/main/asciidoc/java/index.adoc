...
A link:apidocs/io/vertx/ext/apex/Router.html[`Router`] is one of the core concepts of Apex.

A router is an object which maintains zero or more link:apidocs/io/vertx/ext/apex/Route.html[`Route`]s.
...
When a route matches the handler for the route will be called, passing in an instance of link:apidocs/io/vertx/ext/apex/RoutingContext.html[`RoutingContext`].

If you don't end the request in your handler, you can call link:apidocs/io/vertx/ext/apex/RoutingContext.html#next--[`next`] then the router
...
You can also specify a route is handled last, with link:apidocs/io/vertx/ext/apex/Route.html#last-boolean-[`last`]
...
You can disable a route with link:apidocs/io/vertx/ext/apex/Route.html#disable--[`disable`].
...
To retrieve cookies you can use link:apidocs/io/vertx/ext/apex/RoutingContext.html#getCookie-java.lang.String-[`getCookie`] to retrieve
one by name, or use link:apidocs/io/vertx/ext/apex/RoutingContext.html#cookies--[`cookies`] to retrieve the entire set.
...
To enable sessions in your application you make sure you have a link:apidocs/io/vertx/ext/apex/handler/SessionHandler.html[`SessionHandler`]
...
Instead, the link:apidocs/io/vertx/ext/apex/RoutingContext.html#data--[`data`] is available in the template.
