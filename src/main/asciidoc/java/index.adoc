...
`link:../../apidocs/io/vertx/ext/web/handler/sockjs/PermittedOptions.html#setRequiredRole-java.lang.String-[setRequiredRole]` field.
...
`link:../../apidocs/io/vertx/ext/web/handler/sockjs/PermittedOptions.html#setRequiredPermission-java.lang.String-[setRequiredPermission]` field.
