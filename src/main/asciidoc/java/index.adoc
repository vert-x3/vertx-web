...
To limit the size of a request body, create the body handler with `link:apidocs/io/vertx/ext/apex/handler/BodyHandler.html#create-long-[BodyHandler.create]`
...
principal with `link:apidocs/io/vertx/ext/apex/Session.html#isLoggedIn--[isLoggedIn]` and `link:apidocs/io/vertx/ext/apex/Session.html#getPrincipal--[getPrincipal]`.
