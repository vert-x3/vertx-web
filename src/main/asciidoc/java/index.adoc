...
A `link:../../apidocs/io/vertx/ext/apex/Router.html[Router]` is one of the core concepts of Apex. It's an object which maintains zero or more
`link:../../apidocs/io/vertx/ext/apex/Route.html[Routes]` .
...
The object that gets passed into the handler is a `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html[RoutingContext]` - this contains
...
to `link:../../apidocs/io/vertx/ext/apex/Router.html#accept-io.vertx.core.http.HttpServerRequest-[accept]`.
...
of `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html[RoutingContext]`.

If you don't end the response in your handler, you should call `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#next--[next]` so another
matching route can handle the request (if any).

You don't have to call `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#next--[next]` before the handler has finished executing.
...
If you want a route to only match for a specific HTTP method you can use `link:../../apidocs/io/vertx/ext/apex/Route.html#method-io.vertx.core.http.HttpMethod-[method]`
...
If you want to route for a specific HTTP method you can also use the methods such as `link:../../apidocs/io/vertx/ext/apex/Router.html#get--[get]`,
`link:../../apidocs/io/vertx/ext/apex/Router.html#post--[post]` and `link:../../apidocs/io/vertx/ext/apex/Router.html#put--[put]` named after the HTTP
...
If you want to specify a route will match for more than HTTP method you can call `link:../../apidocs/io/vertx/ext/apex/Route.html#method-io.vertx.core.http.HttpMethod-[method]`
multiple times:
...
If the handler subsequently calls `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#next--[next]` the handler for the next
...
If you want to override the default ordering for routes, you can do so using `link:../../apidocs/io/vertx/ext/apex/Route.html#order-int-[order]`,
...
You can also specify that a route is handled last, with `link:../../apidocs/io/vertx/ext/apex/Route.html#last-boolean-[last]`

== Routing based on MIME type of request

You can specify that a route will match against matching request MIME types using `link:../../apidocs/io/vertx/ext/apex/Route.html#consumes-java.lang.String-[consumes]`.

In this case, the request will contain a `content-type` header specifying the MIME type of the request body.
This will be matched against the value specified in `link:../../apidocs/io/vertx/ext/apex/Route.html#consumes-java.lang.String-[consumes]`.
...
By using `link:../../apidocs/io/vertx/ext/apex/Route.html#produces-java.lang.String-[produces]` you define which MIME type(s) the route produces, e.g. the
...
`link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#getAcceptableContentType--[getAcceptableContentType]` to find out the actual MIME type that
was accepted.
...
You can disable a route with `link:../../apidocs/io/vertx/ext/apex/Route.html#disable--[disable]`. A disabled route will be ignored when matching.

You can re-enable a disabled route with `link:../../apidocs/io/vertx/ext/apex/Route.html#enable--[enable]`

== Context data

You can use the context data in the `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html[RoutingContext]` to maintain any data that you
...
You can use the `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#put-java.lang.String-java.lang.Object-[put]` to put any object, and
`link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#get-java.lang.String-[get]` to retrieve any object from the context data.
...
Alternatively you can access the entire context data map with `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#data--[data]`.
...
`link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#fail-int-[fail]` specifying an HTTP status code to deliberately signal a failure.
...
The `link:../../apidocs/io/vertx/ext/apex/handler/BodyHandler.html[BodyHandler]` allows you to retrieve request bodies, limit body sizes and handle
file uploads.
...
If you know the request body is JSON, then you can use `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#getBodyAsJson--[getBodyAsJson]`,
if you know it's a string you can use `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#getBodyAsString--[getBodyAsString]`, or to
retrieve it as a buffer use `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#getBody--[getBody]`.

=== Limiting body size

To limit the size of a request body, create the body handler then use `link:../../apidocs/io/vertx/ext/apex/handler/BodyHandler.html#setBodyLimit-long-[setBodyLimit]`
...
you can use disable it with `link:../../apidocs/io/vertx/ext/apex/handler/BodyHandler.html#setMergeFormAttributes-boolean-[setMergeFormAttributes]`.
...
context with `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#fileUploads--[fileUploads]`.
...
Each file upload is described by a `link:../../apidocs/io/vertx/ext/apex/FileUpload.html[FileUpload]` instance, which allows various properties
such as the name, file-name and size to be accessed.

== Handling cookies

Apex has cookies support using the `link:../../apidocs/io/vertx/ext/apex/handler/CookieHandler.html[CookieHandler]`.
...
You use `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#getCookie-java.lang.String-[getCookie]` to retrieve
a cookie by name, or use `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#cookies--[cookies]` to retrieve the entire set.

To remove a cookie, use `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#removeCookie-java.lang.String-[removeCookie]`.

To add a cookie use `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#addCookie-io.vertx.ext.apex.Cookie-[addCookie]`.
...
Cookies are described by instances of `link:../../apidocs/io/vertx/ext/apex/Cookie.html[Cookie]`. This allows you to retrieve the name,
...
To enable sessions in your application you must have a `link:../../apidocs/io/vertx/ext/apex/handler/SessionHandler.html[SessionHandler]`
...
`link:../../apidocs/io/vertx/ext/apex/sstore/LocalSessionStore.html#create-io.vertx.core.Vertx-java.lang.String-long-[LocalSessionStore.create]`.

Here are some examples of creating a `link:../../apidocs/io/vertx/ext/apex/sstore/LocalSessionStore.html[LocalSessionStore]`
...
Here are some examples of creating a `link:../../apidocs/io/vertx/ext/apex/sstore/ClusteredSessionStore.html[ClusteredSessionStore]`
...
You'll also need to include a `link:../../apidocs/io/vertx/ext/apex/handler/CookieHandler.html[CookieHandler]` as the session handler uses cookies to
...
In your handlers you an access the session instance with `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#session--[session]`.

You put data into the session with `link:../../apidocs/io/vertx/ext/apex/Session.html#put-java.lang.String-java.lang.Object-[put]`,
you get data from the session with `link:../../apidocs/io/vertx/ext/apex/Session.html#get-java.lang.String-[get]`, and you remove
data from the session with `link:../../apidocs/io/vertx/ext/apex/Session.html#remove-java.lang.String-[remove]`.
...
You can manually destroy a session using `link:../../apidocs/io/vertx/ext/apex/Session.html#destroy--[destroy]`. This will remove the session
...
You can also use `link:../../apidocs/io/vertx/ext/apex/Session.html#setAccessed--[setAccessed]` to manually mark a session as accessed.
...
`link:../../apidocs/io/vertx/ext/apex/Session.html#isLoggedIn--[isLoggedIn]` and you can get the principal with
`link:../../apidocs/io/vertx/ext/apex/Session.html#getPrincipal--[getPrincipal]`.

If you want to cause the user to be logged out you can call `link:../../apidocs/io/vertx/ext/apex/Session.html#logout--[logout]`.
...
When the basic auth handler receives this information, it calls the configured `link:../../apidocs/io/vertx/ext/auth/AuthProvider.html[auth service]`
...
To use redirect auth you configure an instance of `link:../../apidocs/io/vertx/ext/apex/handler/RedirectAuthHandler.html[RedirectAuthHandler]` instead of a
basic auth handler.

You will also need to setup handlers to serve your actual login page, and a handler to handle the actual login itself.
To handle the login we provide a prebuilt handler `link:../../apidocs/io/vertx/ext/apex/handler/FormLoginHandler.html[FormLoginHandler]` for the purpose.
...
`link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html[StaticHandler]`.
...
`link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html#setMaxAgeSeconds-long-[setMaxAgeSeconds]` if required.
...
If handling of cache headers is not required, it can be disabled with `link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html#setCachingEnabled-boolean-[setCachingEnabled]`.
...
`link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html#setFilesReadOnly-boolean-[setFilesReadOnly]`.

To enable the maximum number of entries that can be cached in memory at any one time you can use
`link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html#setMaxCacheSize-int-[setMaxCacheSize]`.

To configure the expiry time of cache entries you can use `link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html#setCacheEntryTimeout-long-[setCacheEntryTimeout]`.
...
This can be configured with `link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html#setIndexPage-java.lang.String-[setIndexPage]`.

=== Changing the web root

By default static resources will be served from the directory `webroot`. To configure this use
`link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html#setWebRoot-java.lang.String-[setWebRoot]`.

=== Serving hidden files

By default the serve will serve hidden files (files starting with `.`).

If you do not want hidden files to be served you can configure it with `link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html#setIncludeHidden-boolean-[setIncludeHidden]`.

=== Directory listing

The server can also perform directory listing. By default directory listing is disabled. To enabled it use
`link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html#setDirectoryListing-boolean-[setDirectoryListing]`.
...
`link:../../apidocs/io/vertx/ext/apex/handler/StaticHandler.html#setDirectoryTemplate-java.lang.String-[setDirectoryTemplate]`.
...
Apex includes a handler `link:../../apidocs/io/vertx/ext/apex/handler/CorsHandler.html[CorsHandler]` that handles the CORS protocol for you.
...
Template engines are described by `link:../../apidocs/io/vertx/ext/apex/templ/TemplateEngine.html[TemplateEngine]`. In order to render a template
`link:../../apidocs/io/vertx/ext/apex/templ/TemplateEngine.html#render-io.vertx.ext.apex.RoutingContext-java.lang.String-io.vertx.core.Handler-[render]` is used.

The simplest way to use templates is not to call the template engine directly but to use the
`link:../../apidocs/io/vertx/ext/apex/handler/TemplateHandler.html[TemplateHandler]`.
...
When using the `link:../../apidocs/io/vertx/ext/apex/templ/MVELTemplateEngine.html[MVEL template engine]`, it will by default look for
templates with the `.templ` extension if no extension is specified in the file name.

The routing context `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html[RoutingContext]` is available
...
When using the `link:../../apidocs/io/vertx/ext/apex/templ/JadeTemplateEngine.html[Jade template engine]`, it will by default look for
...
When using the `link:../../apidocs/io/vertx/ext/apex/templ/HandlebarsTemplateEngine.html[Handlebars template engine]`, it will by default look for
...
Instead, the context `link:../../apidocs/io/vertx/ext/apex/RoutingContext.html#data--[data]` is available in the template.
...
When using the `link:../../apidocs/io/vertx/ext/apex/templ/ThymeleafTemplateEngine.html[Thymeleaf template engine]`, it will by default look for
...
The handler is `link:../../apidocs/io/vertx/ext/apex/handler/ErrorHandler.html[ErrorHandler]`. To use the error handler just set it as a
failure handler for any paths that you want covered.

== Request logger

Apex includes a handler `link:../../apidocs/io/vertx/ext/apex/handler/LoggerHandler.html[LoggerHandler]` that you can use to log HTTP requests.
...
Apex includes the handler `link:../../apidocs/io/vertx/ext/apex/handler/FaviconHandler.html[FaviconHandler]` especially for serving favicons.
...
This is configured using an instance of `link:../../apidocs/io/vertx/ext/apex/handler/TimeoutHandler.html[TimeoutHandler]`.
...
Vert.x provides an out of the box handler called `link:../../apidocs/io/vertx/ext/apex/handler/sockjs/SockJSHandler.html[SockJSHandler]` for
using SockJS in your Apex applications.

You should create one handler per SockJS application using `link:../../apidocs/io/vertx/ext/apex/handler/sockjs/SockJSHandler.html#create-io.vertx.core.Vertx-[SockJSHandler.create]`.
You can also specify configuration options when creating the instance. The configuration options are described with
an instance of `link:../../apidocs/io/vertx/ext/apex/handler/sockjs/SockJSHandlerOptions.html[SockJSHandlerOptions]`.
...
The object passed into the handler is a `link:../../apidocs/io/vertx/ext/apex/handler/sockjs/SockJSSocket.html[SockJSSocket]`. This has a familiar
...
The handler can be configured with various options using `link:../../apidocs/io/vertx/ext/apex/handler/sockjs/SockJSHandlerOptions.html[SockJSHandlerOptions]`.
...
terminating at at a `link:../../apidocs/io/vertx/ext/apex/handler/sockjs/SockJSHandler.html[SockJSHandler]` on the server-side.

A special SockJS socket handler is then installed on the `link:../../apidocs/io/vertx/ext/apex/handler/sockjs/SockJSHandler.html[SockJSHandler]` which
handles the SockJS data and bridges it to and from the server side event bus.

To activate the bridge you simply call
`link:../../apidocs/io/vertx/ext/apex/handler/sockjs/SockJSHandler.html#bridge-io.vertx.ext.apex.handler.sockjs.BridgeOptions-[bridge]` on the
SockJS handler.
...
`link:../../apidocs/io/vertx/ext/apex/handler/sockjs/BridgeOptions.html[BridgeOptions]` that you pass in when calling bridge.

Each match is a `link:../../apidocs/io/vertx/ext/apex/handler/sockjs/PermittedOptions.html[PermittedOptions]` object:

`link:../../apidocs/io/vertx/ext/apex/handler/sockjs/PermittedOptions.html#setAddress-java.lang.String-[setAddress]`:: This represents the exact address the message is being sent to. If you want to allow messages based on
an exact address you use this field.
`link:../../apidocs/io/vertx/ext/apex/handler/sockjs/PermittedOptions.html#setAddressRegex-java.lang.String-[setAddressRegex]`:: This is a regular expression that will be matched against the address. If you want to allow messages
based on a regular expression you use this field. If the `address` field is specified this field will be ignored.
`link:../../apidocs/io/vertx/ext/apex/handler/sockjs/PermittedOptions.html#setMatch-io.vertx.core.json.JsonObject-[setMatch]`:: This allows you to allow messages based on their structure. Any fields in the match must exist in the
...
`link:../../apidocs/io/vertx/ext/apex/handler/sockjs/PermittedOptions.html#setRequiredRole-java.lang.String-[setRequiredRole]` field.
...
`link:../../apidocs/io/vertx/ext/apex/handler/sockjs/PermittedOptions.html#setRequiredPermission-java.lang.String-[setRequiredPermission]` field.
...
`link:../../apidocs/io/vertx/ext/apex/handler/sockjs/SockJSHandler.html#bridge-io.vertx.ext.apex.handler.sockjs.BridgeOptions-io.vertx.core.Handler-[bridge]`.

Whenever an event occurs on the bridge it will be passed to the handler. The event is described by an instance of
`link:../../apidocs/io/vertx/ext/apex/handler/sockjs/BridgeEvent.html[BridgeEvent]`.
...
The event enables you to retrieve the type using `link:../../apidocs/io/vertx/ext/apex/handler/sockjs/BridgeEvent.html#type--[type]` and
inspect the raw message of the event using `link:../../apidocs/io/vertx/ext/apex/handler/sockjs/BridgeEvent.html#rawMessage--[rawMessage]`.
...
router.route("/eventbus").handler(sockJSHandler);
>>>>>>> Implemented event bus bridge events
----