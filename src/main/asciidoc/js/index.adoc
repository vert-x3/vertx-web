...
To limit the size of a request body, create the body handler with `link:jsdoc/body_handler-BodyHandler.html#create[BodyHandler.create]`
...
an instance of `link:dataobject/SockJSHandlerOptions.html[SockJSHandlerOptions]`.
...
The handler can be configured with various options using `link:dataobject/SockJSHandlerOptions.html[SockJSHandlerOptions]`.
...
`link:dataobject/BridgeOptions.html[BridgeOptions]` that you pass in when calling bridge.
