...
To create an auth handler you need an instance of `link:../../vertx-auth/js/jsdoc/auth_provider-AuthProvider.html[AuthProvider]`. Auth provider is
...
config.Java.type("io.vertx.ext.auth.shiro.PropertiesProviderConstants").PROPERTIES_PROPS_PATH_FIELD = "classpath:test-auth.properties";

var authProvider = ShiroAuth.create(vertx, 'PROPERTIES', config);
...
If the auth handler has successfully authenticated and authorised the user it will inject a `link:../../vertx-auth/js/jsdoc/user-User.html[User]`
...
When the basic auth handler receives this information, it calls the configured `link:../../vertx-auth/js/jsdoc/auth_provider-AuthProvider.html[AuthProvider]`
...
authConfig.Java.type("io.vertx.ext.auth.shiro.PropertiesProviderConstants").PROPERTIES_PROPS_PATH_FIELD = "classpath:test-auth.properties";
var authProvider = ShiroAuth.create(vertx, 'PROPERTIES', authConfig);
