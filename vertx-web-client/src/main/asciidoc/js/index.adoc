...
----
dependencies {
  compile 'io.vertx:vertx-web-client:3.5.1-SNAPSHOT'
}
----
...
Beware though that `link:../../jsdoc/module-vertx-web-client-js_http_request-HttpRequest.html[HttpRequest]` instances are mutable.
Therefore you should call the `link:../../jsdoc/module-vertx-web-client-js_http_request-HttpRequest.html#copy[copy]` method before modifying a cached instance.
