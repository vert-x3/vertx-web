...
client.get(8080, "myserver.mycompany.com", "/some-uri").send(VertxWebCommon::BodyCodec.json_object()) { |ar_err,ar|
  if (ar_err == nil)
    response = ar
...
----
require 'vertx-web-common/body_codec'
client.get(8080, "myserver.mycompany.com", "/some-uri").send(VertxWebCommon::BodyCodec.json(Java::ExamplesWebClientExamples::User::class)) { |ar_err,ar|
  if (ar_err == nil)
    response = ar
...
----
require 'vertx-web-common/body_codec'
client.get(8080, "myserver.mycompany.com", "/some-uri").send(VertxWebCommon::BodyCodec.pipe(writeStream)) { |ar_err,ar|
  if (ar_err == nil)
...
----
require 'vertx-web-common/body_codec'
client.get(8080, "myserver.mycompany.com", "/some-uri").send(VertxWebCommon::BodyCodec.none()) { |ar_err,ar|
  if (ar_err == nil)
