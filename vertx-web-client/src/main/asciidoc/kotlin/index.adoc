...
var url = client.get(8080, "myserver.mycompany.com", "/some-uri").rxSend().map<Any>({ io.vertx.rxjava.ext.web.client.HttpResponse.bodyAsString() })
...
fun getPayload() : rx.Observable<io.vertx.rxjava.core.buffer.Buffer>{
