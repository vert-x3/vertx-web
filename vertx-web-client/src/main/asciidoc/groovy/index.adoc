...
WARNING: responses are fully buffered, use `link:../../apidocs/io/vertx/ext/web/client/BodyCodec.html#pipe-io.vertx.core.streams.WriteStream-[BodyCodec.pipe]`
...
Custom response body decoding can be achieved using `link:../../apidocs/io/vertx/ext/web/client/BodyCodec.html[BodyCodec]`:
...
Use `link:../../apidocs/io/vertx/ext/web/client/BodyCodec.html#jsonObject--[BodyCodec.jsonObject]` To decode a Json object:
...
When large response are expected, use the `link:../../apidocs/io/vertx/ext/web/client/BodyCodec.html#pipe-io.vertx.core.streams.WriteStream-[BodyCodec.pipe]`.
...
Finally if you are not interested at all by the response content, the `link:../../apidocs/io/vertx/ext/web/client/BodyCodec.html#none--[BodyCodec.none]`
