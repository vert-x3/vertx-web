...
a POJO (Plain Old Java Object) to a Json object. This method tries to use a {@link io.vertx.core.spi.json.JsonCodec}
if available registered with SPI, otherwise it fallbacks to {@link io.vertx.core.json.Json#encode(java.lang.Object)}
method
...
{@link io.vertx.ext.web.codec.BodyCodec#json(java.lang.Class)} tries to load a {@io.vertx.core.spi.json.JsonCodec}
from the SPI, otherwise it fallbacks to Jackson mapper
