...
a POJO (Plain Old Java Object) to a Json object. This method tries to use a {@link io.vertx.core.json.JsonCodec}
...
{@link io.vertx.ext.web.codec.BodyCodec#json(java.lang.Class)} tries to load a {@io.vertx.core.json.JsonCodec}
