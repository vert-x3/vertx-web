...
If you want to upload your file and send attributes, you can use the {@link io.vertx.ext.web.client.HttpRequest#sendMultipartForm(java.util.List, io.vertx.core.Handler)} alternatively.
