  ...
  class BodyCodec
    ...
    def self.string(encoding=nil)
      if !block_given? && encoding == nil
        ...
        return ::Vertx::Util::Utils.safe_create(Java::IoVertxWebclient::BodyCodec.java_method(:string, [Java::java.lang.String.java_class]).call(encoding),::VertxWebClient::BodyCodec, nil)
      end
