...
require 'vertx-web-client/http_response_builder'
...
module VertxWebClient
  ...
  #    <li>{::VertxWebClient::HttpRequestBuilder#buffer_body}</li>
  #  </ul>
  #  can be called.
  #  <p>
  #  The <code>#bufferBody</code> configures the builder to buffer the entire HTTP response body and returns a
  #  {::VertxWebClient::HttpResponseBuilder} for configuring the response body.
  #  <p>
  ...
  class HttpRequestBuilder
    ...
    #  Configure to buffer the body and returns a {::VertxWebClient::HttpResponseBuilder< Buffer >} for further configuration of
    #  the response or {::VertxWebClient::HttpResponseBuilder#send(Handler) sending} the request.
    # @return [::VertxWebClient::HttpResponseBuilder]
    def buffer_body
      if !block_given?
        return ::Vertx::Util::Utils.safe_create(@j_del.java_method(:bufferBody, []).call(),::VertxWebClient::HttpResponseBuilder,::Vertx::Buffer.j_api_type)
      end
