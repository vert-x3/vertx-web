...
module VertxWebClient
  ...
  class HttpRequestTemplate
    ...
    def request_uri(value=nil)
      if value.class == String && !block_given?
        return ::Vertx::Util::Utils.safe_create(@j_del.java_method(:requestURI, [Java::java.lang.String.java_class]).call(value),::VertxWebClient::HttpRequestTemplate)
      end
    ...
    def buffer_body
      if !block_given?
        return ::Vertx::Util::Utils.safe_create(@j_del.java_method(:bufferBody, []).call(),::VertxWebClient::HttpResponseTemplate,::Vertx::Buffer.j_api_type)
      end
