...
var HttpResponseBuilder = function(j_val, j_arg_0) {
  ...
  this.send = function(handler) {
    ...
    if (__args.length === 1 && typeof __args[0] === 'function') {
      j_httpResponseBuilder["send(io.vertx.core.Handler)"](function(ar) {
      if (ar.succeeded()) {
  ...
  /**
   Like {@link HttpResponseBuilder#send} but with an HTTP request <code>body</code> stream.
  ...
  this.sendStream = function(body, handler) {
    ...
    if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'function') {
      j_httpResponseBuilder["sendStream(io.vertx.core.streams.ReadStream,io.vertx.core.Handler)"](body._jdel, function(ar) {
      if (ar.succeeded()) {
        handler(utils.convReturnVertxGen(HttpResponse, ar.result(), undefined), null);
      } else {
        handler(null, ar.cause());
  ...
  /**
   Like {@link HttpResponseBuilder#send} but with an HTTP request <code>body</code> buffer.
  ...
  this.sendBuffer = function(body, handler) {
    var __args = arguments;
    if (__args.length === 2 && typeof __args[0] === 'object' && __args[0]._jdel && typeof __args[1] === 'function') {
      j_httpResponseBuilder["sendBuffer(io.vertx.core.buffer.Buffer,io.vertx.core.Handler)"](body._jdel, function(ar) {
      if (ar.succeeded()) {
        handler(utils.convReturnVertxGen(HttpResponse, ar.result(), undefined), null);
      } else {
        handler(null, ar.cause());
  ...
  /**
   Like {@link HttpResponseBuilder#send} but with an HTTP request <code>body</code> json and the content type
  ...
  this.sendJson = function(body, handler) {
    ...
    if (__args.length === 2 && typeof __args[0] !== 'function' && typeof __args[1] === 'function') {
      j_httpResponseBuilder["sendJson(java.lang.Object,io.vertx.core.Handler)"](utils.convParamTypeUnknown(body), function(ar) {
      if (ar.succeeded()) {
        handler(utils.convReturnVertxGen(HttpResponse, ar.result(), undefined), null);
      } else {
        handler(null, ar.cause());
  ...
  /**
   Like {@link HttpResponseBuilder#asString} but with the specified <code>encoding</code> param.
  ...
  this.asString = function() {
    var __args = arguments;
    if (__args.length === 0) {
      return utils.convReturnVertxGen(HttpResponseBuilder, j_httpResponseBuilder["asString()"](), undefined);
    }  else if (__args.length === 1 && typeof __args[0] === 'string') {
      return utils.convReturnVertxGen(HttpResponseBuilder, j_httpResponseBuilder["asString(java.lang.String)"](__args[0]), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
  ...
  /**
   ...
   @return {HttpResponseBuilder} a new <code>HttpResponseBuilder</code> instance decoding the response as a Json object
   */
  this.asJsonObject = function() {
    var __args = arguments;
    if (__args.length === 0) {
      return utils.convReturnVertxGen(HttpResponseBuilder, j_httpResponseBuilder["asJsonObject()"](), undefined);
    } else throw new TypeError('function invoked with invalid arguments');
  };
