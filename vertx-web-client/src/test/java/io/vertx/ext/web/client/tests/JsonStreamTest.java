...
public class JsonStreamTest {
  ...
  @Test
  public void testSimpleStream(Vertx vertx, VertxTestContext testContext) {
  ...
  @Test
  public void testSimpleStreamUsingBlankLine(Vertx vertx, VertxTestContext testContext) {
    AtomicInteger counter = new AtomicInteger();
    JsonParser parser = JsonParser.newParser().objectValueMode()
      .exceptionHandler(testContext::failNow)
      .handler(event -> {
