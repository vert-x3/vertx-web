...
public class SseClientTest {
  ...
  public void testGetSseEvents(Vertx vertx, VertxTestContext testContext) throws Exception {
  ...
  @Test
  @Timeout(value = 10, unit = TimeUnit.SECONDS)
  public void testMultilineData(Vertx vertx, VertxTestContext testContext) throws Exception {
    final List<SseEvent> events = new ArrayList<>();
  ...
  @Test
  @Timeout(value = 10, unit = TimeUnit.SECONDS)
  public void testComments(Vertx vertx, VertxTestContext testContext) throws Exception {
    final List<SseEvent> events = new ArrayList<>();
  ...
  @Test
  @Timeout(value = 10, unit = TimeUnit.SECONDS)
  public void testRetryField(Vertx vertx, VertxTestContext testContext) throws Exception {
    final List<SseEvent> events = new ArrayList<>();
  ...
  @Test
  @Timeout(value = 10, unit = TimeUnit.SECONDS)
  public void testNoEventType(Vertx vertx, VertxTestContext testContext) throws Exception {
    final List<SseEvent> events = new ArrayList<>();
  ...
  @Test
  @Timeout(value = 10, unit = TimeUnit.SECONDS)
  public void testBurstEvents(Vertx vertx, VertxTestContext testContext) throws Exception {
    final List<SseEvent> events = new ArrayList<>();
  ...
  public void testBackpressure(Vertx vertx, VertxTestContext testContext) throws Exception {
    final List<SseEvent> events = new ArrayList<>();
  ...
  @Test
  @Timeout(value = 10, unit = TimeUnit.SECONDS)
  public void testExceptionHandler(Vertx vertx, VertxTestContext testContext) throws Exception {
