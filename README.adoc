...
Please see the in source asciidoc link:vertx-web/src/main/asciidoc/java/index.adoc[documentation] or the main http://vertx.io/docs/#web[documentation] on the web-site for a full description
of Vert.x-Web:
