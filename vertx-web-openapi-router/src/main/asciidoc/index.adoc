...
[source,$lang]
----
{@link examples.openapi.router.RouterExamples#createRouter}
----
...
[source,$lang]
----
{@link examples.openapi.router.RouterExamples#accessValidatedRequest}
----
...
[source,$lang]
----
{@link examples.openapi.router.RouterExamples#securityConfiguration}
----
...
[source,$lang]
----
{@link examples.openapi.router.RouterExamples#securityConfigurationOauth2}
----
...
[source,$lang]
----
{@link examples.openapi.router.RouterExamples#securityConfigurationOpenIdConnect}
----
