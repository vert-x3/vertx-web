 ...
 * @param requireSecurityHandlers  If true, when you call [io.vertx.ext.web.api.contract.DesignDrivenRouterFactory] the factory will mount for every path the required security handlers and, if a security handler is not defined, it throws an [io.vertx.ext.web.api.contract.RouterFactoryException]
 *
 * <p/>
...
fun DesignDrivenRouterFactoryOptions(
  ...
  requireSecurityHandlers: Boolean? = null): DesignDrivenRouterFactoryOptions = io.vertx.ext.web.api.contract.DesignDrivenRouterFactoryOptions().apply {
