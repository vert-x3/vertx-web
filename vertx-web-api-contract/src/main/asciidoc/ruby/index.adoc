...
* It automatically mounts a 501 `Not Implemented` handler for operations where you haven't mounted any handler. You can enable/disable this feature with `link:../dataobjects.html#DesignDrivenRouterFactoryOptions#set_mount_not_implemented_handler-instance_method[mountNotImplementedHandler]` and you can
