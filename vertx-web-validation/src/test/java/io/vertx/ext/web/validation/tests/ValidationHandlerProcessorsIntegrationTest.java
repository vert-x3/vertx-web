...
import static io.vertx.ext.web.validation.tests.testutils.TestRequest.cookie;
import static io.vertx.ext.web.validation.tests.testutils.TestRequest.jsonBodyResponse;
import static io.vertx.ext.web.validation.tests.testutils.TestRequest.requestHeader;
...
import static io.vertx.ext.web.validation.tests.testutils.TestRequest.urlEncode;
import static io.vertx.ext.web.validation.tests.testutils.ValidationTestUtils.badBodyResponse;
import static io.vertx.ext.web.validation.tests.testutils.ValidationTestUtils.badParameterResponse;
